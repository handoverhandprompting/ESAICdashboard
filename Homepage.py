...
def home_content_en():
    ...
    st.write('The predictive models have not undergone external validation. The development of these models have been detailed in Hsu, W. T., et al. (2023). The Worsening Renal Perfusion Index predicts the prognoses of heart failure patients treated with sacubitril/valsartan. Cardiorenal Medicine, 13(1), 310-323, and Chien, T. C. R., et al. (2025). An interactive visualization dashboard for predicting the effect of sacubitril/valsartan initiation in patients with heart failure. Computers in Biology and Medicine, 186, 109667.')
    st.write('The information, data, and output generated by this site are intended to complement, not replace, professional clinical judgment.')
    st.write('The developers make no representations or warranties regarding the accuracy, validity, or completeness of the outputs provided by the dashboard.')

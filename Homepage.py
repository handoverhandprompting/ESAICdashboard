...
def home_content_en():
    ...
    st.write('Access to this website is restricted to licensed healthcare professionals specializing in heart failure management. The ESAIC dashboards do not collect, store, or access any user data. To begin, healthcare professionals can create a reference condition based on a patient’s current clinical profile. By adjusting additional clinical covariates and updating their values, users can explore alternative scenarios and observe how these factors influence prognosis, hazard ratios, and survival probabilities. It is important to note that this prognostic tool is NOT intended to dictate clinical decision-making. Rather, it serves as an objective informational resource for healthcare providers and patients, helping to identify modifiable risk factors and assess potential benefits associated with treatment adjustments.
